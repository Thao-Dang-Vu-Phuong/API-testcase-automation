...
@BeforeClass
public void init() {
	this.myWork = PropertiesFileUtils.getProperties("nameWork");
	this.myExperience = PropertiesFileUtils.getProperties("experience");
	this.myEducation = PropertiesFileUtils.getProperties("education");
	
	HashMap<String, Object> createWork = new HashMap<String, Object>();
	createWork.put("nameWork", myWork);
	createWork.put("experience", myExperience);
	createWork.put("education", myEducation);
